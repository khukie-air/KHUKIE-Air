"""
Django settings for khukieAir project.
...
SECRET_KEY = 'wa9kkfg0gjao*3ry9*+zc9qg4nbd(w8lf^1n630jcca&x%s_=g'
...
DATABASES = {
    'default': {
        ...
        'HOST': KHUKIEAIR_CONFIG['aws']['rds']['endpoint'],
        'PORT': KHUKIEAIR_CONFIG['aws']['rds']['port'],
        'NAME': KHUKIEAIR_CONFIG['aws']['rds']['schema'],
        'USER': KHUKIEAIR_CONFIG['aws']['rds']['user'],
        'PASSWORD': KHUKIEAIR_CONFIG['aws']['rds']['password'],
    }
}
